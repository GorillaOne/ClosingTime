    ...
    {
        public partial class TreeViewItemRuntime : ClosingTime.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.TreeViewItemRuntime.VariableState fromState,ClosingTime.GumRuntimes.DefaultForms.TreeViewItemRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            private ClosingTime.GumRuntimes.DefaultForms.TreeViewToggleButtonRuntime ToggleButtonInstance { get; set; }
            private ClosingTime.GumRuntimes.DefaultForms.ListBoxItemRuntime ListBoxItemInstance { get; set; }
            ...
            {
                ToggleButtonInstance = this.GetGraphicalUiElementByName("ToggleButtonInstance") as ClosingTime.GumRuntimes.DefaultForms.TreeViewToggleButtonRuntime;
                ListBoxItemInstance = this.GetGraphicalUiElementByName("ListBoxItemInstance") as ClosingTime.GumRuntimes.DefaultForms.ListBoxItemRuntime;
