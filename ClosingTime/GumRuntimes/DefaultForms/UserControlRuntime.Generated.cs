    ...
    {
        public partial class UserControlRuntime : ClosingTime.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            Height = 300f;
                            Width = 300f;
                            ColoredFrameInstance.CurrentColorCategoryState = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.TransparentBlack;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.TransparentBlack;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.TransparentBlack;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.UserControlRuntime.VariableState fromState,ClosingTime.GumRuntimes.DefaultForms.UserControlRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
