    ...
    {
        public partial class ScrollBarRuntime : ClosingTime.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                ...
                set
                {
                    ...
                    switch(mCurrentVariableState)
                    {
                        case  VariableState.Default:
                            ...
                            X = 0f;
                            Y = 0f;
                            BackgroundInstance.CurrentColorCategoryState = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
            ...
            public void InterpolateBetween (VariableState firstState, VariableState secondState, float interpolationValue) 
            {
                ...
                ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory BackgroundInstanceCurrentColorCategoryStateFirstValue= ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory BackgroundInstanceCurrentColorCategoryStateSecondValue= ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                ...
                switch(secondState)
                {
                    case  VariableState.Default:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState fromState,ClosingTime.GumRuntimes.DefaultForms.ScrollBarRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory fromState,ClosingTime.GumRuntimes.DefaultForms.ScrollBarRuntime.ScrollBarCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime BackgroundInstance { get; set; }
            private ClosingTime.GumRuntimes.DefaultForms.ButtonRuntime UpButtonInstance { get; set; }
            private ClosingTime.GumRuntimes.DefaultForms.ButtonRuntime DownButtonInstance { get; set; }
            private ClosingTime.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            private ClosingTime.GumRuntimes.SpriteRuntime SpriteInstance1 { get; set; }
            private ClosingTime.GumRuntimes.SpriteRuntime SpriteInstance2 { get; set; }
            private ClosingTime.GumRuntimes.ContainerRuntime ThumbContainer { get; set; }
            ...
            {
                BackgroundInstance = this.GetGraphicalUiElementByName("BackgroundInstance") as ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                UpButtonInstance = this.GetGraphicalUiElementByName("UpButtonInstance") as ClosingTime.GumRuntimes.DefaultForms.ButtonRuntime;
                DownButtonInstance = this.GetGraphicalUiElementByName("DownButtonInstance") as ClosingTime.GumRuntimes.DefaultForms.ButtonRuntime;
                ThumbInstance = this.GetGraphicalUiElementByName("ThumbInstance") as ClosingTime.GumRuntimes.DefaultForms.ScrollBarThumbRuntime;
                SpriteInstance1 = this.GetGraphicalUiElementByName("SpriteInstance1") as ClosingTime.GumRuntimes.SpriteRuntime;
                SpriteInstance2 = this.GetGraphicalUiElementByName("SpriteInstance2") as ClosingTime.GumRuntimes.SpriteRuntime;
                ThumbContainer = this.GetGraphicalUiElementByName("ThumbContainer") as ClosingTime.GumRuntimes.ContainerRuntime;
