    ...
    {
        public partial class PasswordBoxRuntime : ClosingTime.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.PasswordBoxRuntime.VariableState fromState,ClosingTime.GumRuntimes.DefaultForms.PasswordBoxRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.PasswordBoxRuntime.PasswordBoxCategory fromState,ClosingTime.GumRuntimes.DefaultForms.PasswordBoxRuntime.PasswordBoxCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private ClosingTime.GumRuntimes.ColoredRectangleRuntime CaretInstance { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                CaretInstance = this.GetGraphicalUiElementByName("CaretInstance") as ClosingTime.GumRuntimes.ColoredRectangleRuntime;
