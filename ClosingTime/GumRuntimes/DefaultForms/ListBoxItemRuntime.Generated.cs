    ...
    {
        public partial class ListBoxItemRuntime : ClosingTime.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentListBoxItemCategoryState)
                        {
                            case  ListBoxItemCategory.Enabled:
                                BackgroundInstance.CurrentColorCategoryState = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                                break;
                            case  ListBoxItemCategory.Highlighted:
                                BackgroundInstance.CurrentColorCategoryState = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                                BackgroundInstance.X = 0f;
                                BackgroundInstance.XOrigin = RenderingLibrary.Graphics.HorizontalAlignment.Center;
                                BackgroundInstance.XUnits = Gum.Converters.GeneralUnitType.PixelsFromMiddle;
                                BackgroundInstance.Y = 0f;
                            ...
                            case  ListBoxItemCategory.Selected:
                                BackgroundInstance.CurrentColorCategoryState = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                                break;
                        }
                    }
                }
            ...
            public void InterpolateBetween (ListBoxItemCategory firstState, ListBoxItemCategory secondState, float interpolationValue) 
            {
                ...
                switch(firstState)
                {
                    case  ListBoxItemCategory.Enabled:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        break;
                    case  ListBoxItemCategory.Highlighted:
                        setBackgroundInstanceCurrentColorCategoryStateFirstValue = true;
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setBackgroundInstanceXFirstValue = true;
                        BackgroundInstanceXFirstValue = 0f;
                        if (interpolationValue < 1)
                        {
                    ...
                    case  ListBoxItemCategory.Selected:
                        setBackgroundInstanceCurrentColorCategoryStateFirstValue = true;
                        BackgroundInstanceCurrentColorCategoryStateFirstValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        break;
                }
                switch(secondState)
                {
                    case  ListBoxItemCategory.Enabled:
                        ...
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                        break;
                    case  ListBoxItemCategory.Highlighted:
                        setBackgroundInstanceCurrentColorCategoryStateSecondValue = true;
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setBackgroundInstanceXSecondValue = true;
                        BackgroundInstanceXSecondValue = 0f;
                        if (interpolationValue >= 1)
                        {
                    ...
                    case  ListBoxItemCategory.Selected:
                        setBackgroundInstanceCurrentColorCategoryStateSecondValue = true;
                        BackgroundInstanceCurrentColorCategoryStateSecondValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Green;
                        break;
                }
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.ListBoxItemRuntime.VariableState fromState,ClosingTime.GumRuntimes.DefaultForms.ListBoxItemRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.ListBoxItemRuntime.ListBoxItemCategory fromState,ClosingTime.GumRuntimes.DefaultForms.ListBoxItemRuntime.ListBoxItemCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
