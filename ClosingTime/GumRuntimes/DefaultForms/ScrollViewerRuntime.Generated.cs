    ...
    {
        public partial class ScrollViewerRuntime : ClosingTime.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.ScrollViewerRuntime.VariableState fromState,ClosingTime.GumRuntimes.DefaultForms.ScrollViewerRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            private ClosingTime.GumRuntimes.DefaultForms.ScrollBarRuntime VerticalScrollBarInstance { get; set; }
            private ClosingTime.GumRuntimes.ContainerRuntime ClipContainerInstance { get; set; }
            private ClosingTime.GumRuntimes.ContainerRuntime InnerPanelInstance { get; set; }
            ...
            private void AssignReferences () 
            {
                ...
                VerticalScrollBarInstance = this.GetGraphicalUiElementByName("VerticalScrollBarInstance") as ClosingTime.GumRuntimes.DefaultForms.ScrollBarRuntime;
                ClipContainerInstance = this.GetGraphicalUiElementByName("ClipContainerInstance") as ClosingTime.GumRuntimes.ContainerRuntime;
                InnerPanelInstance = this.GetGraphicalUiElementByName("InnerPanelInstance") as ClosingTime.GumRuntimes.ContainerRuntime;
