    ...
    {
        public partial class RadioButtonRuntime : ClosingTime.GumRuntimes.ContainerRuntime
        {
            #region State Enums
                    ...
                    if (value != null)
                    {
                        ...
                        switch(mCurrentRadioButtonCategoryState)
                        {
                            case  RadioButtonCategory.EnabledOn:
                                ...
                                ColoredFrameInstance.CurrentColorCategoryState = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                            ...
                            case  RadioButtonCategory.DisabledOn:
                                ColoredFrameInstance.Blue = 255;
                                ColoredFrameInstance.CurrentColorCategoryState = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                                ColoredFrameInstance.Green = 255;
                                ColoredFrameInstance.Red = 255;
                                SpriteInstance.Visible = true;
                                break;
                            ...
                            case  RadioButtonCategory.HighlightedOn:
                                ColoredFrameInstance.Blue = 255;
                                ColoredFrameInstance.CurrentColorCategoryState = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                                ColoredFrameInstance.Green = 255;
                                ColoredFrameInstance.Red = 255;
                                SpriteInstance.Visible = true;
                                break;
            ...
            public void InterpolateBetween (RadioButtonCategory firstState, RadioButtonCategory secondState, float interpolationValue) 
            {
                ...
                ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory ColoredFrameInstanceCurrentColorCategoryStateFirstValue= ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory ColoredFrameInstanceCurrentColorCategoryStateSecondValue= ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                ...
                switch(firstState)
                {
                    case  RadioButtonCategory.EnabledOn:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                    ...
                    case  RadioButtonCategory.DisabledOn:
                        ...
                        ColoredFrameInstanceBlueFirstValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateFirstValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setColoredFrameInstanceGreenFirstValue = true;
                        ColoredFrameInstanceGreenFirstValue = 255;
                        setColoredFrameInstanceRedFirstValue = true;
                        ColoredFrameInstanceRedFirstValue = 255;
                    ...
                    case  RadioButtonCategory.HighlightedOn:
                        ...
                        ColoredFrameInstanceBlueFirstValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateFirstValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateFirstValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setColoredFrameInstanceGreenFirstValue = true;
                        ColoredFrameInstanceGreenFirstValue = 255;
                        setColoredFrameInstanceRedFirstValue = true;
                        ColoredFrameInstanceRedFirstValue = 255;
                ...
                switch(secondState)
                {
                    case  RadioButtonCategory.EnabledOn:
                        ...
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Gray;
                    ...
                    case  RadioButtonCategory.DisabledOn:
                        ...
                        ColoredFrameInstanceBlueSecondValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateSecondValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Black;
                        setColoredFrameInstanceGreenSecondValue = true;
                        ColoredFrameInstanceGreenSecondValue = 255;
                        setColoredFrameInstanceRedSecondValue = true;
                        ColoredFrameInstanceRedSecondValue = 255;
                    ...
                    case  RadioButtonCategory.HighlightedOn:
                        ...
                        ColoredFrameInstanceBlueSecondValue = 255;
                        setColoredFrameInstanceCurrentColorCategoryStateSecondValue = true;
                        ColoredFrameInstanceCurrentColorCategoryStateSecondValue = ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime.ColorCategory.Yellow;
                        setColoredFrameInstanceGreenSecondValue = true;
                        ColoredFrameInstanceGreenSecondValue = 255;
                        setColoredFrameInstanceRedSecondValue = true;
                        ColoredFrameInstanceRedSecondValue = 255;
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.RadioButtonRuntime.VariableState fromState,ClosingTime.GumRuntimes.DefaultForms.RadioButtonRuntime.VariableState toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.RadioButtonRuntime.RadioButtonCategory fromState,ClosingTime.GumRuntimes.DefaultForms.RadioButtonRuntime.RadioButtonCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime ColoredFrameInstance { get; set; }
            private ClosingTime.GumRuntimes.SpriteRuntime SpriteInstance { get; set; }
            ...
            {
                ColoredFrameInstance = this.GetGraphicalUiElementByName("ColoredFrameInstance") as ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                SpriteInstance = this.GetGraphicalUiElementByName("SpriteInstance") as ClosingTime.GumRuntimes.SpriteRuntime;
