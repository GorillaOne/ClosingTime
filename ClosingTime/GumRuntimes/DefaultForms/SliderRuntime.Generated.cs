    ...
    {
        public partial class SliderRuntime : ClosingTime.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public FlatRedBall.Glue.StateInterpolation.Tweener InterpolateTo (ClosingTime.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory fromState,ClosingTime.GumRuntimes.DefaultForms.SliderRuntime.SliderCategory toState, double secondsToTake, FlatRedBall.Glue.StateInterpolation.InterpolationType interpolationType, FlatRedBall.Glue.StateInterpolation.Easing easing, object owner = null) 
            {
                FlatRedBall.Glue.StateInterpolation.Tweener tweener = new FlatRedBall.Glue.StateInterpolation.Tweener(from:0, to:1, duration:(float)secondsToTake, type:interpolationType, easing:easing );
                if (owner == null)
                {
            ...
            private ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime LineInstance { get; set; }
            private ClosingTime.GumRuntimes.DefaultForms.ScrollBarThumbRuntime ThumbInstance { get; set; }
            private ClosingTime.GumRuntimes.ContainerRuntime ContainerInstance { get; set; }
            ...
            {
                LineInstance = this.GetGraphicalUiElementByName("LineInstance") as ClosingTime.GumRuntimes.DefaultForms.ColoredFrameRuntime;
                ...
                ContainerInstance = this.GetGraphicalUiElementByName("ContainerInstance") as ClosingTime.GumRuntimes.ContainerRuntime;
