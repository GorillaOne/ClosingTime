    ...
    {
        public partial class LevelContainerRuntime : ClosingTime.GumRuntimes.ContainerRuntime
        {
            #region State Enums
            ...
            public LevelContainerRuntime (bool fullInstantiation = true, bool tryCreateFormsObject = true) 
            	: base(false, tryCreateFormsObject)
            {
                if (fullInstantiation)
                {
                    Gum.DataTypes.ElementSave elementSave = Gum.Managers.ObjectFinder.Self.GumProjectSave.Components.First(item => item.Name == "LevelContainer");
