...
{
    public partial class Patron : ClosingTime.Entities.Character, FlatRedBall.Graphics.IDestroyable, FlatRedBall.Performance.IPoolable, FlatRedBall.Math.Geometry.ICollidable
    {
        ...
        public static new string ContentManagerName
        {
            get
            {
                return ClosingTime.Entities.Character.ContentManagerName;
            }
            set
            {
                ClosingTime.Entities.Character.ContentManagerName = value;
            }
        }
        #if DEBUG
        ...
        public float MaxReactionDistance = 100f;
        ...
        public Patron (string contentManagerName) 
        	: this(contentManagerName, true)
        {
        }
        public Patron (string contentManagerName, bool addToManagers) 
        ...
        public override void Destroy () 
        {
            if (Used)
            {
                Factories.PatronFactory.MakeUnused(this, false);
            }
            base.Destroy();
        ...
        public static new void LoadStaticContent (string contentManagerName) 
        {
            ...
            if (LoadedContentManagers.Contains(contentManagerName) == false)
            {
                ...
                lock (mLockObject)
                {
                    ...
                    {
                        FlatRedBall.FlatRedBallServices.GetContentManagerByName(ContentManagerName).AddUnloadMethod("PatronStaticUnload", UnloadStaticContent);
